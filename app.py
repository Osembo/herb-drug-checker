...
# Page config – updated title to reflect main feature
st.set_page_config(
    page_title="TCIM Condition & Herb Explorer | Kenya",
    page_icon="🌿",
    layout="centered",
...
if 'active_tab' not in st.session_state:
    st.session_state.active_tab = "🌿 Condition Explorer"  # Set Condition Explorer as default
...
# Header – updated to highlight the condition explorer
st.markdown("""
    <div class="main-header">
        <h1>🌿 TCIM Condition & Herb Explorer</h1>
        <p>Evidence‑based insights for conditions, herbs, and interactions | Created in Kenya 🇰🇪</p>
    </div>
""", unsafe_allow_html=True)

# ------------------------------------------------------------
# Sidebar Navigation – reordered: Condition Explorer first
# ------------------------------------------------------------
with st.sidebar:
    st.image("https://img.icons8.com/color/96/000000/kenya.png", width=60)
    st.markdown("### Navigation")
    options = ["🌿 Condition Explorer", "🔍 Interaction Checker", "📘 Learn", "📞 Feedback"]
...
# ------------------------------------------------------------
# Condition Explorer Tab (NOW MAIN)
# ------------------------------------------------------------
if st.session_state.active_tab == "🌿 Condition Explorer":
    # ------------------------------------------------------------
    ...
    if selected_condition_name:
        ...
        if species_data is None:
            ...
            # Check for exact match in use_to_bios keys
...
# ------------------------------------------------------------
# Interaction Checker Tab (unchanged, now second)
# ------------------------------------------------------------
elif st.session_state.active_tab == "🔍 Interaction Checker":
    # Language selection
